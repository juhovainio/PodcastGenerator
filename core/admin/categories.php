	...
	*/
		...
		if (file_exists("$absoluteurl"."categories.xml")) {
			...
			$PG_mainbody .= '
				...
				<input name="addcategory" id="addcategory" type="text" size="50" maxlength="255" placeholder="Category name"><br />
				<input name="catdesc" id="categorydesc" type="text" size="50" maxlength="255" placeholder="Category description" ><br />
